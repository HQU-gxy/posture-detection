...
def auth_params(include: Optional[List] = None, params: Optional[Dict] = None):
  """
    为查询请求强制添加查询参数
...
def auth_params_direct(include: Optional[List] = None,
...
def auth_params_exclude(exclude: Optional[List] = None,
                        params: Optional[Dict] = None):
  """
    为查询请求强制添加查询参数
